...
import { client_login } from "../services/firebase-services"
...
class Login extends React.Component{
	...
	onSubmit(){
		...
		client_login(fields.username, fields.password).then((res) => {
			if(res == 1){
				localStorage.setItem('is-client', true)
				...
				<div className='row justify-content-center'>
					<div className='col-md-6'>
						<div className='card mt-5'>
							<div className='card-header'><h5 className='card-title'>Guest Login</h5></div>
